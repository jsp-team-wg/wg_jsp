<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <html lang="ko">
      <head>
        ...
        <title>Q&A 관리</title>
        <link rel="stylesheet" href="../../resource/css/adminQna.css" />
      </head>
      <body>
          ...
          <main>
            ...
            <section class="section-top">
              ...
              <div class="section-top-category-name">
                ...
                <div class="section-top-category-name-text2">Q&A - 관리</div>
              </div>
            </section>
            ...
            <section class="section-board">
              ...
              <div class="board-outer-box">
                <a class="board-inner-box" href="${pageContext.request.contextPath}/community/qna/qnaViewDetail/qnaViewDetail.jsp">
                  <!-- 이너박스 상단 -->
